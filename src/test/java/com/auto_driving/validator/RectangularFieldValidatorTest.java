...
public class RectangularFieldValidatorTest {
    ...
    public void testNonNumericalValuesForWidth() {
        RectangularFieldValidator validator = new RectangularFieldValidator();
        NumberFormatException exception = assertThrows(NumberFormatException.class, () -> validator.validate("a 1"));
    ...
    public void testNonNumericalValuesForHeight() {
        RectangularFieldValidator validator = new RectangularFieldValidator();
        NumberFormatException exception = assertThrows(NumberFormatException.class, () -> validator.validate("3 yay"));
        assertEquals("Invalid values. Please enter numerical values.", exception.getMessage());
    }
    ...
    public void testNonNumericalValuesForWidthAndHeight() {
        RectangularFieldValidator validator = new RectangularFieldValidator();
        NumberFormatException exception = assertThrows(NumberFormatException.class, () -> validator.validate("abc def"));
        assertEquals("Invalid values. Please enter numerical values.", exception.getMessage());
    }
    ...
    public void testZeroWidth() {
        RectangularFieldValidator validator = new RectangularFieldValidator();
        NonPosititveValueException exception = assertThrows(NonPosititveValueException.class, () -> validator.validate("0 5"));
    ...
    public void testZeroHeight() {
        RectangularFieldValidator validator = new RectangularFieldValidator();
        NonPosititveValueException exception = assertThrows(NonPosititveValueException.class, () -> validator.validate("3 0"));
        assertEquals("Please input values that are more than 0.", exception.getMessage());
    }
    ...
    public void testZeroWidthAndHeight() {
        RectangularFieldValidator validator = new RectangularFieldValidator();
        NonPosititveValueException exception = assertThrows(NonPosititveValueException.class, () -> validator.validate("0 0"));
        assertEquals("Please input values that are more than 0.", exception.getMessage());
    }
    ...
    public void testNegativeWidth() {
        RectangularFieldValidator validator = new RectangularFieldValidator();
        NonPosititveValueException exception = assertThrows(NonPosititveValueException.class, () -> validator.validate("-2 5"));
        assertEquals("Please input values that are more than 0.", exception.getMessage());
    }
    ...
    public void testNegativeHeight() {
        RectangularFieldValidator validator = new RectangularFieldValidator();
        NonPosititveValueException exception = assertThrows(NonPosititveValueException.class, () -> validator.validate("3 -8"));
        assertEquals("Please input values that are more than 0.", exception.getMessage());
    }
    ...
    public void testNegativeWidthAndHeight() {
        RectangularFieldValidator validator = new RectangularFieldValidator();
        NonPosititveValueException exception = assertThrows(NonPosititveValueException.class, () -> validator.validate("-2 -8"));
        assertEquals("Please input values that are more than 0.", exception.getMessage());
    }
}
